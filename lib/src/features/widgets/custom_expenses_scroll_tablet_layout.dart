...
import 'package:responsive_dashboard/src/features/widgets/custom_linear_section.dart';
...
class CustomExpensesScrollTabletLayout extends StatelessWidget {
  const CustomExpensesScrollTabletLayout({super.key});
